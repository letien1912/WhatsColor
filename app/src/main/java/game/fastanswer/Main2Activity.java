...
//  }
  ...
  private void onConnected(GoogleSignInAccount googleSignInAccount) {
    ...
    if (mSignedInAccount != googleSignInAccount) {
      ...
      mInvitationsClient = Games.getInvitationsClient(Main2Activity.this, googleSignInAccount);
    ...
    GamesClient gamesClient = Games.getGamesClient(Main2Activity.this, googleSignInAccount);
